...
class firstChuangxinCandidate(scrapy.Spider):
    name = 'firstChuangxinCandidate_url'
    # find_url = []
    # unfind_url = []
    ...
    def start_requests(self):
        ...
        all_people = json.load(codecs.open('allRencaiInfoScrapy/data/1st_chuangxin_candidate.json', 'r', encoding='utf-8'))

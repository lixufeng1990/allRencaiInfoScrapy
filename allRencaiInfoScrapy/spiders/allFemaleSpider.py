...
class allFemaleSpider(scrapy.Spider):
    name = 'all_female_url'
    # find_url = []
    # unfind_url = []
    ...
    def start_requests(self):
        ...
        all_people = json.load(codecs.open('allRencaiInfoScrapy/data/all_female_scientists.json', 'r', encoding='utf-8'))

...
class RencaiSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        qingke_people = json.load(codecs.open('allRencaiInfoScrapy/data/all_female_scientists.json', 'r', encoding='utf-8'))
        for person in qingke_people:
            query_condition = person['name']+' -女'+person['birthDay'] + person['major'][:3]

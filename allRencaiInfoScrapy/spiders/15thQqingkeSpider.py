...
class fiftyQingkeSpider(scrapy.Spider):
    name = 'fiftyQingke_url'
    # find_url = []
    # unfind_url = []
    ...
    def start_requests(self):
        ...
        all_people = json.load(codecs.open('allRencaiInfoScrapy/data/15th_qingke_candidate.json', 'r', encoding='utf-8'))
